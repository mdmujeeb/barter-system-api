package com.mujeeb.barter.util;
...
public abstract class Errors {
	...
	static {
		...
		errorMap.put(27, "Invalid Orders Id.");
		...
		errorMap.put(31, "Orders details do not Match.");
		errorMap.put(32, "Online payment amount cannot be greater than Orders amount.");
		errorMap.put(33, "Invalid Online payment method.");
		errorMap.put(34, "Unable to connect to Payment Gateway.");
		errorMap.put(35, "Duplicate Orders Id.");
		...
		errorMap.put(41, "Invalid Orders status.");
		...
		errorMap.put(46, "Status of a Draft Orders cannot be changed.");
		...
		errorMap.put(50, "Orders cannot be cancelled by this api call.");
		errorMap.put(51, "Orders is not eligible for Cancellation.");
		errorMap.put(52, "Invalid Transaction Id.");
		errorMap.put(53, "Invalid Vehicle Id.");
		errorMap.put(54, "Orders Type cannot be empty.");
		errorMap.put(55, "Vehicle Id is required for Full Tank Orders.");
	}

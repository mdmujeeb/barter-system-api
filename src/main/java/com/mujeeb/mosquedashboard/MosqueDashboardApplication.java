		...
		return (args) -> {
			...
			try {
				...
				for (CSVRecord record : csvParser) {
					...
					repository.save(new User(Integer.parseInt(masjidId)
												, description
												, password
		...
		return (args) -> {
			...
			try {
				...
				for (CSVRecord record : csvParser) {
					...
					repository.save(new Product(Integer.parseInt(id)
							, name
							, time
		...
		return (args) -> {
			...
			try {
				...
				for (CSVRecord record : csvParser) {
					...
					repository.save(new Category(Integer.parseInt(id)
							, name
							, Integer.parseInt(masjidId)));
				}
			} catch(Exception ex) {
		...
		return (args) -> {
			...
			try {
				...
				for (CSVRecord record : csvParser) {
					...
					repository.save(new Listing(Long.parseLong(id)
							, description
		...
		return (args) -> {
			...
			try {
				...
				for (CSVRecord record : csvParser) {
					...
					repository.save(new Order(Integer.parseInt(id)
							, ayat));
				}
			} catch(Exception ex) {
		...
		return (args) -> {
			...
			try {
				...
				for (CSVRecord record : csvParser) {
					...
					repository.save(new ExchangeRequest(Integer.parseInt(date)
							, seheri
							, iftar
							, Integer.parseInt(masjidId)));
				}
